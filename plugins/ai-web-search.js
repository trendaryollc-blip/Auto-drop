  ...
  async search(query, numResults) {
    ...
    try {
      switch(provider) {
        ...
        case 'serper': return await this.searchSerper(query, key, numResults);
        case 'brave': return await this.searchBrave(query, key, numResults);
        default: return this.fallbackSearch(query);
      }
    } catch(e) {
