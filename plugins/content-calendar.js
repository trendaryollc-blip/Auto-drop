...
(function () {
  ...
  const PLATFORMS = [
    {
      ...
      icon: '🎵',
      color: '#00f2ea',
      bestTimes: '8-11am, 7-10pm',
      bestDays: 'Tue, Thu, Sat',
      contentMix: '60% Reels, 20% Trends, 20% UGC',
    },
    {
      name: 'Instagram',
      icon: '📸',
      ...
      contentMix: '40% Reels, 30% Carousels, 30% Stories',
    },
    {
      name: 'Facebook',
      icon: '📘',
      ...
      contentMix: '50% Video Ads, 30% Carousel, 20% Lead Gen',
    },
    {
      name: 'Pinterest',
      icon: '📌',
      ...
      bestTimes: '8-11pm',
      bestDays: 'Sat, Sun',
      contentMix: '50% Idea Pins, 30% Standard, 20% Video',
    },
    {
      name: 'YouTube',
      icon: '▶️',
      ...
      contentMix: '40% Shorts, 30% Reviews, 30% Unboxing',
    },
  ];
  ...
  const CONTENT_TYPES = {
    tiktok: [
      {
        type: 'Hook Video',
        desc: '3-5 second attention grabber',
        best: '8-11am, 7-10pm',
        difficulty: 'Easy',
        reach: 'High',
      },
      ...
      {
        type: 'Trend Jack',
        desc: 'Ride a trending sound/format',
        best: 'Trending hours',
        difficulty: 'Easy',
        reach: 'Viral',
      },
      ...
      {
        type: 'POV Skit',
        desc: 'Relatable scenario with product',
        best: '7-10pm',
        difficulty: 'Medium',
        reach: 'Very High',
      },
    ...
    facebook: [
      ...
      {
        type: 'Carousel Ad',
        desc: 'Multi-image product showcase',
        best: '10am-12pm',
        difficulty: 'Medium',
        reach: 'Medium',
      },
  ...
  function generateCalendar(product) {
    const cal = [],
      now = new Date(),
      cat = matchCategory(product),
      hashtags = HASHTAG_SETS[cat] || HASHTAG_SETS.electronics;
    ...
    for (let i = 0; i < 90; i++) {
      ...
      cal.push({
        ...
        platform,
        contentType,
        hook: generateHook(product, holiday, contentType.type, cat),
        caption: generateCaption(product, holiday, platform.name, hashtags),
        hashtags: shuffleHashtags(hashtags, 5),
        holiday,
        isWeekend,
        isToday: i === 0,
  ...
  function generateHook(product, holiday, type, _cat) {
    ...
    const hooks = {
      'Hook Video': [
        ...
        'Stop scrolling — this ' + kw + ' is a game changer',
        "I can't believe this costs only $" + product.price.toFixed(2),
        'The ' + kw + ' everyone on TikTok is buying',
        'Wait for it... the ' + kw + ' transformation',
      ],
      Tutorial: [
        'How to get the most out of your ' + shortName,
        '3 ways to use your ' + kw + " you didn't know",
        'Step-by-step ' + kw + ' setup guide',
        'The right way to use a ' + kw,
      ],
      'Before/After': [
        'Before vs After using ' + shortName,
        'The difference is INSANE — ' + kw + ' results',
        'Day 1 vs Day 30 with my ' + kw,
        'Watch this transformation with ' + shortName,
      ],
      'Trend Jack': [
        "Everyone's doing the " + kw + ' challenge',
        'Trying the viral ' + kw + ' trend',
        'The ' + kw + " trend is everywhere — here's why",
      ],
      'UGC Stitch': [
        "Stitching this customer's reaction to " + shortName,
        'This review of ' + shortName + ' is everything',
        'Real people, real results with ' + kw,
      ],
      'POV Skit': [
        'POV: You finally upgraded your ' + kw,
        'POV: Your friend asks where you got your ' + kw,
        "POV: You're the only one with a " + kw,
      ],
      Reel: [
        '✨ The ' + kw + " everyone's been asking about",
        'This ' + kw + ' is worth every penny',
        'Unboxing the ' + shortName + ' — honest review',
        'The ' + kw + ' trend is REAL',
      ],
      Carousel: [
        '5 reasons you need a ' + kw + ' in your life',
        'The complete guide to ' + kw + ' — swipe for tips',
        '' + kw.charAt(0).toUpperCase() + kw.slice(1) + ' 101: Everything you need to know',
        "Do's and Don'ts of " + kw,
      ],
      'Story Poll': [
        'Have you tried a ' + kw + '? YES / NOT YET',
        "What's your biggest " + kw + ' struggle?',
        'Rate your ' + kw + ' setup 1-10',
      ],
      'Static Post': [
        'The ' + shortName + " that's breaking the internet 🌐",
        'Your new favorite ' + kw + ' has arrived',
        'Sleek. Functional. Affordable. Meet your new ' + kw,
      ],
      'Live Demo': [
        'LIVE: Testing ' + shortName + ' — ask me anything!',
        'Going live to show you why this ' + kw + ' is special',
        'Live Q&A: Everything about ' + shortName,
      ],
      'Collab Post': [
        'Partnered with @' + kw.replace(/\s/g, '') + 'fan to bring you this review',
        'Collab: Our take on the ' + shortName,
      ],
      'Video Ad': [
        "🔥 Don't buy a " + kw + ' until you see this',
        'The #1 ' + kw + " of 2026 — here's why",
        'This ' + kw + ' pays for itself in ' + Math.ceil(product.price / product.cpaAvg) + ' days',
      ],
      'Carousel Ad': [
        'Why 10,000+ people chose this ' + kw,
        'Before you buy ANY ' + kw + ', read this',
        'The ' + kw + ' comparison chart you need',
      ],
      'Lead Gen': [
        'Get our FREE ' + kw + ' buying guide',
        'Exclusive ' + kw + ' deal — enter email to unlock',
        'Free shipping on ' + shortName + ' — limited time',
      ],
      Retargeting: [
        'Still thinking about the ' + shortName + "? It's selling fast",
        'You viewed ' + shortName + " — here's 15% off",
        'Your ' + kw + " is waiting — don't miss out",
      ],
      'Social Proof': [
        '' + product.reviews.toLocaleString() + " people can't be wrong about this " + kw,
        '⭐⭐⭐⭐⭐ — See why ' + product.orders + ' people ordered this ' + kw,
        'This ' + kw + ' has a ' + product.rating + '★ rating for a reason',
      ],
      'Live Stream': [
        'LIVE: ' + shortName + ' — Everything you want to know',
        'Going live to demo ' + kw + ' — drop your questions!',
        'Live ' + kw + ' Q&A + exclusive discount code',
      ],
      'Idea Pin': [
        'The ultimate ' + kw + ' guide — save this!',
        '5 ' + kw + ' hacks you NEED to know',
        '' + kw.charAt(0).toUpperCase() + kw.slice(1) + ' inspo for your home',
      ],
      'Standard Pin': [
        'Shop the ' + shortName + ' — link in description',
        'The ' + kw + ' of your dreams ✨',
        'Upgrade your ' + kw + ' game',
      ],
      ...
      Short: [
        'The ' + kw + ' that went viral for a reason',
        '60 seconds to change how you think about ' + kw,
        '' + kw.charAt(0).toUpperCase() + kw.slice(1) + ' — too good not to share',
      ],
      Review: [
        'Honest ' + shortName + ' review — is it worth it?',
        'I tested ' + shortName + " for 30 days — here's my verdict",
        '' + kw.charAt(0).toUpperCase() + kw.slice(1) + ' deep dive review',
      ],
      Unboxing: [
        'Unboxing the ' + shortName + ' — first impressions!',
        "What's inside the " + kw + ' package?',
        'The ' + kw + " unboxing you've been waiting for",
      ],
      Comparison: [
        '' + shortName + ' vs the competition — which wins?',
        'I compared the top 5 ' + kw + " — here's the winner",
        'The ' + kw + ' showdown: which is best?',
      ],
    };
    let hook = (hooks[type] || hooks['Hook Video'])[
      Math.floor(Math.random() * (hooks[type] || hooks['Hook Video']).length)
    ];
  ...
  function generateCaption(product, holiday, platform, _hashtags) {
    const caps = {
      TikTok:
        'This ' +
        product.keywords[0] +
        ' is going viral for a reason 🔥 Only $' +
      ...
      Instagram:
        'Your new favorite ' +
        product.keywords[0] +
        ' has arrived ✨ Premium quality at factory prices. Tap to shop 👆\n\n' +
        product.rating +
        '★ rated • ' +
        product.orders +
      ...
      Pinterest:
        ...
        ' — The must-have ' +
        product.keywords[0] +
        ' for 2026. Shop now for $' +
        product.price.toFixed(2),
      YouTube:
        "In this video I'm reviewing the " +
        product.title.split('—')[0].trim() +
        ". Is it worth the hype? Let's find out. Links in description 👇",
    };
  ...
  function renderFn(_product) {
    ...
    cal.forEach((d) => {
      ...
      platformBreakdown[n] = (platformBreakdown[n] || 0) + 1;
    });
  ...
  function renderCalendarViewFn(cal) {
    ...
    cal.forEach((day, i) => {
      ...
      if (m !== currentMonth) {
        currentMonth = m;
        html += `<div class="cc-month-header">${months[m]} ${day.date.getFullYear()}</div>`;
      }
  ...
  function renderListViewFn(cal) {
    ...
    if (!el) return;
    el.innerHTML = `<div class="cc-list">${cal
      .map((day, i) => {
  ...
  function showDetailFn(day) {
    ...
    const closeDetail = () => {
      panel.classList.remove('cc-detail-open');
      panel.innerHTML = '';
    };
  ...
  const ContentCalendarPlugin = {
    ...
    init(_ctx) {
      Config.defaults('contentCalendar', { enabled: true });
    },
    ...
    mount(_ctx) {
      ...
      if (input)
        input.addEventListener('keypress', (e) => {
          if (e.key === 'Enter') generateFn(input.value);
        });
      section.querySelectorAll('.cc-quick-btn').forEach((b) => {
        b.addEventListener('click', () => {
          input.value = b.dataset.q;
          generateFn(b.dataset.q);
        });
      });
    },
