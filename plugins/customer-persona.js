...
(function () {
  ...
  const PersonaTemplates = [
    {
      ...
      lifestyle:
        'Health-conscious millennial, shops online 3-4x/week, active on Instagram & TikTok, values convenience and aesthetics',
      fears: [
        "Wasting money on products that don't work",
        'Being tricked by fake reviews',
        'Looking foolish to friends',
        'Buying something everyone else already has',
      ],
      desires: [
        'Find products that actually solve her problems',
        'Look put-together without effort',
        'Save time on daily routines',
        'Discover trending products before friends',
      ],
      buyingTriggers: [
      ...
      objections: [
        '"Is this just another TikTok trend?"',
        '"Will this actually work for ME?"',
        '"I\'ve been burned by similar products before"',
        '"The price seems too good to be true"',
      ],
      persuasionAngles: [
        'Lead with the problem she faces daily',
        'Show real women (not models) using it',
        'Emphasize the money-back guarantee',
        'Create FOMO with countdown timers',
        'Use her exact language in ad copy',
      ],
      language: [
        'literally obsessed',
        'worth every penny',
      ...
      priceRange: {
        low: 'Under $15 = impulse buy',
        $mid: '$15-40 = reads reviews first',
        $high: '$40+ = needs strong social proof',
      },
      contentFormats: [
        'Short-form video (Reels/TikTok)',
        'Before/after carousel photos',
        'Story polls and Q&A',
        'Influencer try-on hauls',
        'Customer review compilations',
      ],
      socialProof: [
        'Thousands of 5-star reviews',
        'Real customer before/after photos',
        '"As seen on TikTok" badges',
        'Influencer unboxings',
        'Money-back guarantee badges',
      ],
      purchaseWindow: {
        best: 'Evenings 8-11pm, Sunday afternoons',
        worst: 'Monday mornings, late night 2-5am',
        seasonal: 'Pre-holiday surges, New Year resolutions, Summer prep',
      },
      competitorMindset: [
        'Checks Amazon reviews first',
        'Compares 3-4 similar products',
        'Waits for a sale or coupon code',
        'Reads Reddit for honest opinions',
        'Trusts micro-influencers over big names',
      ],
      checkoutBehavior: {
        abandons: ['High shipping costs', 'No reviews visible', 'Complicated checkout', 'No return policy shown'],
        completes: [
          'One-click checkout',
      ...
      fbTargeting: {
        age: '25-44',
        interests: ['Online Shopping', 'Beauty Tools', 'Home Organization', 'Fitness Gadgets', 'Kitchen Innovations'],
        behaviors: ['Engaged Shoppers', 'Online Buyers', 'Mobile Buyers'],
        countries: ['US', 'UK', 'CA', 'AU'],
      },
      tiktokTargeting: {
        age: '18-34',
        interests: ['Life Hacks', 'Product Reviews', 'ASMR', 'Satisfying Videos'],
        behaviors: ['Commenters', 'Savers', 'Share Creators'],
      },
      adCopy:
        "Stop wasting money on products that promise everything and deliver nothing. This ${product} has helped 12,847 women save time every single morning. See why it's selling out →",
    },
    {
      name: 'Jason Park',
      age: '22-30',
      ...
      lifestyle:
        'Tech-savvy gamer and gadget enthusiast, watches YouTube reviews before buying, active on Reddit and Twitter, values performance and novelty',
      fears: [
        'Buying an inferior product',
        'Missing out on the latest tech',
        'Overpaying for something basic',
        'Getting called out for a bad purchase',
      ],
      desires: [
        'Own the coolest tech before anyone else',
        'Optimize his daily setup',
        'Impress friends with unique finds',
        'Find hidden gems at good prices',
      ],
      buyingTriggers: [
        'Unboxing videos and reviews',
        'Technical specs and benchmarks',
        'Early-adopter pricing',
        'Community validation (Reddit upvotes)',
        'Unique/innovative design',
      ],
      objections: [
        '"I can probably find this cheaper on AliExpress"',
        '"Is this actually better than [competitor]?"',
        '"The specs don\'t look that impressive"',
        '"I don\'t trust paid reviews"',
      ],
      persuasionAngles: [
        'Lead with technical innovation',
        'Compare directly to competitors',
        'Show it in a real desk/setup environment',
        'Use Reddit-style social proof',
      ...
      priceRange: {
        low: 'Under $20 = instant cop',
        $mid: '$20-60 = checks r/BuyItForLife',
        $high: '$60+ = needs video review proof',
      },
      contentFormats: [
        'YouTube unboxing/review',
        'Reddit comparison posts',
        'Tech benchmark videos',
        'Desk setup tours',
        'Side-by-side comparison reels',
      ],
      socialProof: [
        'Reddit thread recommendations',
        'YouTube review consensus',
        'Spec comparison charts',
        'Community upvotes',
        '"Best of 2026" list placements',
      ],
      purchaseWindow: {
        best: 'Weekday evenings 7-10pm, Saturday afternoons',
        worst: 'Sunday mornings, work hours 9-5',
        seasonal: 'Product launch cycles, Black Friday, Prime Day',
      },
      competitorMindset: [
        'Always comparing specs',
        'Reads every review on multiple platforms',
        'Watches 3+ YouTube reviews before buying',
        'Checks AliExpress/Temu for cheaper versions',
        'Values brand reputation and warranty',
      ],
      checkoutBehavior: {
        abandons: [
          'Slow page load',
          'No spec details listed',
      ...
      fbTargeting: {
        age: '18-35',
        interests: ['Tech Gadgets', 'Gaming Setup', 'Smart Home', 'EDC Gear', 'Phone Accessories'],
        behaviors: ['Tech Early Adopters', 'Online Spend: High'],
        countries: ['US', 'UK', 'CA'],
      },
      tiktokTargeting: {
        age: '18-28',
        interests: ['Tech Reviews', 'Gadget Unboxing', 'Desk Setup', 'Gaming'],
        behaviors: ['High Engagement', 'Commenters'],
      },
      adCopy:
        "This ${product} is the gadget nobody's talking about yet — but everyone will be. 2,400+ orders this month. Don't be the last to find out →",
    },
    {
      ...
      lifestyle:
        'Busy working mom, shops for the whole family, values practicality and durability, reads Amazon reviews thoroughly, active on Facebook groups',
      fears: [
        'Wasting money on junk',
        'Products that break after a week',
        "Feeling like she's being scammed online",
        'Not getting good value for the family budget',
      ],
      desires: [
        'Make family life easier and more organized',
        'Find products that last',
        'Save money without sacrificing quality',
        'Keep kids happy and entertained',
      ],
      buyingTriggers: [
        'Amazon reviews (1000+ verified)',
        'Parent blogger recommendations',
        'Money-back guarantee',
        'Practical demonstrations',
        'Multi-use/value bundles',
      ],
      objections: [
        '"This looks cheap — will it last?"',
        '"I can\'t afford to waste money right now"',
        '"My kids will break this in a week"',
        '"Why should I trust this over a known brand?"',
      ],
      persuasionAngles: [
        'Lead with family-specific use cases',
        'Show durability tests',
        'Highlight cost-per-use savings',
        'Use mom-community testimonials',
        'Offer family bundles at discount',
      ],
      language: [
        ...
        'got this for the whole house',
        'practical and sturdy',
      ],
      priceRange: {
        low: 'Under $20 = yes please',
        $mid: '$20-50 = checks reviews carefully',
        $high: '$50+ = needs durability guarantee',
      },
      contentFormats: [
        'Facebook group testimonials',
        'Amazon review screenshots',
        'Mom blogger recommendations',
        'Before/after home photos',
        'Family use demonstration videos',
      ],
      socialProof: [
        '1000+ verified Amazon reviews',
        'Mom blogger endorsements',
        '"Mom approved" badges',
        'Durability test videos',
        'Money-back guarantee prominently displayed',
      ],
      purchaseWindow: {
        best: 'Nap time 1-3pm, after bedtime 9-11pm',
        worst: 'Morning rush 7-9am, during work hours',
        seasonal: 'Back-to-school, holidays, spring cleaning',
      },
      competitorMindset: [
        'Checks Amazon first, reads top 50 reviews',
        'Asks in Facebook mom groups',
        'Compares durability and warranty',
        'Looks for family bundle deals',
        'Trusts other moms over influencers',
      ],
      checkoutBehavior: {
        abandons: [
          'No reviews visible',
          ...
          'No family bundle available',
        ],
        completes: [
          'Amazon-style review section',
          'Clear return policy',
          'Free shipping',
          'Bundle discount visible',
          'Trust badges displayed',
        ],
      },
      fbTargeting: {
        age: '30-50',
        interests: ['Mom Life', 'Family Organization', 'Budget Shopping', 'Home Hacks', 'Kids Activities'],
        behaviors: ['Parents with Young Children', 'Online Shoppers'],
        countries: ['US', 'UK', 'CA', 'AU'],
      },
      tiktokTargeting: {
        age: '25-45',
        interests: ['MomTok', 'Parenting Tips', 'Home Organization', 'Family Hacks'],
        behaviors: ['Savers', 'Share Creators'],
      },
      adCopy:
        "Every mom needs this in her kitchen. It's saved me 30 minutes every single day — and it's under $25. 8,400+ 5-star reviews from other moms say the same →",
    },
    {
      name: 'Alex Thompson',
      age: '19-26',
      ...
      lifestyle:
        'Gen Z trendsetter, discovers products through TikTok, aesthetic-focused, values sustainability and uniqueness, impulse buyer with strong FOMO',
      fears: [
        'Being basic or basic',
        'Supporting unethical brands',
        "Products that don't match the aesthetic",
        'Missing a viral trend',
      ],
      desires: [
        'Curate a unique personal aesthetic',
        'Support eco-friendly brands',
        "Find products that look expensive but aren't",
      ...
      objections: [
        '"This is just another dropshipping scam"',
        '"The aesthetic looks different in real life"',
        '"Is this actually sustainable or greenwashing?"',
        '"I saw this on TikTok last month already"',
      ],
      persuasionAngles: [
        'Lead with aesthetic/lifestyle imagery',
        'Emphasize sustainability credentials',
        'Show unfiltered real-life usage',
        'Create exclusive/limited feel',
        'Use Gen Z language and humor',
      ],
      language: [
        'the aesthetic is immaculate',
        'periodt',
        'slay',
        'caught me at "sustainable"',
        "this is giving what it's supposed to give",
        'not me wanting everything',
        'vibes only',
      ],
      priceRange: {
        low: 'Under $15 = no thoughts just vibes',
        $mid: '$15-35 = checks if it\'s "worth"',
        $high: '$35+ = needs aesthetic proof and reviews',
      },
      contentFormats: [
        'TikTok GRWM videos',
        'Aesthetic flat lay photos',
        'Sustainability story highlights',
        'Unfiltered real-life reels',
        'Creator "day in my life" content',
      ],
      socialProof: [
        'TikTok viral count',
        'Sustainability certifications',
        'Creator collaborations',
        '"10K+ people bought this"',
        'User-generated aesthetic photos',
      ],
      purchaseWindow: {
        best: 'Late night 10pm-1am, weekend afternoons',
        worst: 'Early mornings, weekday work hours',
        seasonal: 'Viral trend cycles, festival season, holiday gifting',
      },
      competitorMindset: [
        'Compares aesthetics across platforms',
        'Checks if it\'s "TikTok famous"',
        'Looks for sustainability proof',
        'Reads comments for real opinions',
        'Compares to similar viral products',
      ],
      checkoutBehavior: {
        abandons: ['Ugly product page', 'No lifestyle photos', 'No sustainability info', 'Standard shipping only'],
        completes: [
          'Aesthetic product page',
          'Lifestyle imagery',
          'Eco-friendly shipping option',
          'Social media login checkout',
          'Limited stock indicator',
        ],
      },
      fbTargeting: {
        age: '18-28',
        interests: ['Aesthetic Lifestyle', 'Sustainable Living', 'Thrift Finds', 'Art & Design', 'Minimalism'],
        behaviors: ['Mobile Buyers', 'Social Media Active'],
        countries: ['US', 'UK', 'AU', 'CA'],
      },
      tiktokTargeting: {
        age: '18-24',
        interests: ['Aesthetic', 'Room Decor', 'Sustainable Finds', 'GRWM', 'Haul'],
        behaviors: ['High Comment Rate', 'Share Creators'],
      },
      adCopy:
        "POV: you found the ${product} that matches your entire aesthetic AND it's sustainable. 6,200 people agree → Link in bio before it sells out",
    },
  ];

  const ProductPersonas = {
    'wireless earbuds': {
      triggers: ['Noise cancellation for focus', 'Gym-ready fit', 'Battery life anxiety'],
      objections: ['"AirPods are better"', '"These will fall out"'],
      angles: ['Compare to $200 earbuds', 'Show workout footage', 'Battery life comparison chart'],
      keywords: ['earbuds', 'headphones', 'airpods', 'buds'],
    },
    'pet gadgets': {
      triggers: ['Pet parent guilt', 'Want the best for fur baby', 'Convenience for busy owners'],
      objections: ['"My pet won\'t use this"', '"Is this safe?"'],
      angles: ['Show pet reactions', 'Vet endorsement angle', 'Convenience pitch'],
      keywords: ['pet', 'dog', 'cat', 'pet gadget'],
    },
    'kitchen organizer': {
      triggers: ['Kitchen chaos frustration', 'Instagram-worthy kitchen', 'Meal prep efficiency'],
      objections: ['"My kitchen is too small"', '"I\'ll never keep it organized"'],
      angles: ['Before/after transformation', 'Small kitchen solutions', 'Time-saving pitch'],
      keywords: ['kitchen', 'organizer', 'storage', 'cabinet'],
    },
    'posture corrector': {
      triggers: ['WFH back pain', 'Looking confident', 'Preventing long-term damage'],
      objections: ['"I\'ll forget to wear it"', '"Those braces look uncomfortable"'],
      angles: ['Doctor recommendation', 'Before/after posture shots', 'Discreet under clothes'],
      keywords: ['posture', 'back', 'corrector', 'brace'],
    },
    'galaxy projector': {
      triggers: ['Room aesthetic transformation', 'Unique gift idea', 'Movie night vibes'],
      objections: ['"Will it actually look good?"', '"Is it bright enough?"'],
      angles: ['Room transformation reveal', 'Date night setup', 'Gift guide placement'],
      keywords: ['galaxy', 'projector', 'star', 'light', 'ambient'],
    },
    'beauty tool': {
      triggers: ['Salon results at home', 'Time-saving routine', 'Instagram-ready look'],
      objections: ['"I\'m not skilled enough"', '"This looks complicated"'],
      angles: ['5-minute transformation', 'Celebrity routine angle', 'Beginner-friendly pitch'],
      keywords: ['beauty', 'skin', 'face', 'facial', 'skincare'],
    },
    'fitness gadget': {
      triggers: ['Home gym upgrade', 'Accountability tool', 'Visible progress tracking'],
      objections: ['"I can do this without equipment"', '"Gym membership is better"'],
      angles: ['Results comparison', 'Home vs gym convenience', 'Progress photos'],
      keywords: ['fitness', 'gym', 'workout', 'muscle', 'exercise'],
    },
    'phone accessories': {
      triggers: ['Phone protection', 'Aesthetic upgrade', 'Functional improvement'],
      objections: ['"My phone case is fine"', '"These always break"'],
      angles: ['Drop test footage', 'Aesthetic matching', 'Multi-functional pitch'],
      keywords: ['phone', 'case', 'charger', 'cable', 'accessories'],
    },
    'home decor': {
      triggers: ['Space transformation', 'Guest impression', 'Mood improvement'],
      objections: ['"Won\'t match my style"', '"Looks cheaper in person"'],
      angles: ['Room makeover reveal', 'Style quiz approach', 'Satisfaction guarantee'],
      keywords: ['decor', 'home', 'wall', 'room', 'furniture'],
    },
    'car accessories': {
      triggers: ['Car upgrade on a budget', 'Road trip convenience', 'Clean car aesthetic'],
      objections: ['"Will this fit my car?"', '"Installation looks hard"'],
      angles: ['Universal fit guarantee', 'Before/after car tour', 'Easy install demo'],
      keywords: ['car', 'vehicle', 'auto', 'driving', 'dashboard'],
    },
  };
  ...
  const AdHeadlines = {
    'Sarah Mitchell': [
      {
        ...
        headline: "Stop wasting $50/month on products that don't work",
        cta: 'Shop the fix →',
      },
      ...
      {
        type: 'Before/After',
        headline: 'From "this won\'t work" to "where has this been all my life"',
        cta: 'Try it risk-free →',
      },
      { type: 'Question Hook', headline: "Why didn't anyone tell me about this sooner?", cta: 'Find out why →' },
      {
        type: 'Urgency',
        headline: '50% OFF ends tonight — this ${product} never goes on sale',
    ...
    'Jason Park': [
      {
        type: 'Specs Lead',
        headline: 'This ${product} just beat [competitor] in every benchmark',
        cta: 'See the data →',
      },
      {
        type: 'Value Prop',
        headline: '$30 gadget that outperforms $150 alternatives — verified',
        cta: 'Check specs →',
      },
      {
        type: 'Community',
        headline: "Reddit's #1 recommendation this month — 2,400+ orders",
        cta: 'Join the consensus →',
      },
      {
        type: 'Comparison',
        headline: 'I tested 5 ${product}s. This one destroyed the competition',
        cta: 'See results →',
      },
      {
        type: 'Technical',
        headline: "Finally, a ${product} that doesn't compromise on performance",
        cta: 'View specs →',
      },
    ...
    'Maria Rodriguez': [
      {
        type: 'Mom Endorsement',
        headline: 'Mom of 3 says: "This saved me 30 minutes every day"',
        cta: 'See why moms love it →',
      },
      { type: 'Durability', headline: 'Bought this 8 months ago — still works like day one', cta: 'Built to last →' },
      {
        type: 'Family Value',
        headline: 'Under $25 and the whole family uses it — 8,400+ reviews',
        cta: 'Shop family deals →',
      },
    ...
    'Alex Thompson': [
      {
        type: 'Aesthetic',
        headline: 'POV: you found the ${product} that matches your entire vibe',
        cta: 'Shop the aesthetic →',
      },
      {
        type: 'Sustainability',
        headline: 'Caught me buying sustainable ${product}s that look this good',
        cta: 'Eco-friendly finds →',
      },
      { type: 'Viral', headline: '6,200 people bought this last week — TikTok was right', cta: 'Join the trend →' },
      {
        type: 'Exclusivity',
        headline: 'Limited drop: the ${product} your feed has been waiting for',
        cta: "Don't sleep on this →",
      },
      { type: 'FOMO GenZ', headline: 'Not me buying this at 2am... okay maybe I am', cta: 'No thoughts just vibes →' },
      {
        type: 'Social Proof',
        headline: 'This ${product} went viral for a reason — 10K+ sold',
        cta: "See what's hype →",
      },
    ],
  };
      ...
      welcome: [
        {
          ...
          body: "Hey! Welcome to the club. We're obsessed with finding products that actually work (no more wasted money). Here's your 15% off code: WELCOME15. Happy shopping!",
        },
        {
          subject: 'The ${product} story (and why 12K+ women love it)',
          body: "Quick story: we found this ${product} and couldn't believe how well it worked. So we asked our community... 12,847 five-star reviews later, here we are. See why they're obsessed →",
        },
        {
          subject: '"Is this legit?" (honest answer inside)',
          body: "We get it — you've been burned before. That's why we offer free returns, 30-day guarantee, and real customer photos (not stock models). Try it risk-free.",
        },
      ],
      abandoned: [
        {
          subject: 'You left something behind... 👀',
          body: "Hey! Your ${product} is still in your cart. We get it — life happens. But this one's selling fast and we'd hate for you to miss out. Complete your order →",
        },
        {
          subject: "Still thinking? Here's what other women say...",
          body: "We noticed you didn't finish checkout. No pressure — but here are 3 reviews from women just like you who almost didn't buy it. \"Literally the best purchase I've made this year\" →",
        },
        {
          subject: 'Last chance: your 10% off expires tonight ⏰',
          body: "Your cart is waiting with 10% OFF applied: SAVE10. This code expires at midnight. Don't let this one slip away →",
        },
      ],
      postPurchase: [
        {
          subject: 'Your order is on its way! 📦',
          body: 'Exciting news — your ${product} shipped! Track it here. Pro tip: check the unboxing guide we included to get the most out of it from day one.',
        },
        {
          subject: "How's your ${product}? (quick favor)",
          body: "Hey! It's been a week — how are you loving your new ${product}? If it's a game changer, we'd love a quick review. It helps other women like you find it!",
        },
        {
          subject: 'Your friends need this too 🎁',
          body: "Know someone who'd love this ${product}? Share your referral link and you both get $10 off. Win-win!",
        },
      ],
    },
    'Jason Park': {
      welcome: [
        {
          subject: 'Welcome to the inner circle — 10% off inside',
          body: "You're in. We curate the best tech gadgets before they hit mainstream. Here's your 10% welcome code: TECH10. Let's upgrade your setup.",
        },
        {
          subject: 'The ${product} that outperforms [competitor] — benchmarks inside',
          body: 'We ran the numbers. This ${product} beat [competitor] in 7/10 benchmarks. Full comparison chart inside. The data speaks for itself.',
        },
        {
          subject: 'Why we picked this ${product} (our selection process)',
          body: "We test 50+ gadgets monthly. Only 2 make the cut. Here's why this ${product} passed our 7-point quality check →",
        },
      ],
      abandoned: [
        {
          subject: 'Your ${product} cart — specs comparison vs alternatives',
          body: 'Still deciding? We built a quick spec comparison: this ${product} vs 3 alternatives at the same price. Spoiler: it wins on battery, build quality, and value.',
        },
        {
          subject: 'Reddit is talking about your cart item 👀',
          body: 'Found 3 Reddit threads about this ${product}. Consensus: "honestly pretty solid bang for buck." Thought you\'d want to know.',
        },
        {
          subject: 'Price drop alert: your ${product} is 15% off today only',
          body: "Flash deal: the ${product} in your cart just dropped 15%. One day only. We don't do sales often →",
        },
      ],
      postPurchase: [
        {
          subject: '${product} shipped — estimated arrival',
          body: "Your ${product} is on its way. ETA: 3-5 days. Quick start guide included in the box. We'd love to see your setup when it arrives.",
        },
        {
          subject: 'Rate your ${product} (and get 5% off next order)',
          body: 'Honest question: does the ${product} live up to the specs? Leave a review and get 5% off your next order. No bias — we publish all reviews.',
        },
        {
          subject: 'The accessory combo most buyers add',
          body: '80% of ${product} owners also grabbed [accessory]. Bundle deal: get both for 20% off. Just saying →',
        },
      ],
    },
    'Maria Rodriguez': {
      welcome: [
        {
          subject: "Welcome, mama! Here's your family discount 🏠",
          body: 'Hey! Welcome to our community of 8,400+ moms who found products that actually work for the whole family. Your 15% off code: MOM15. You deserve this.',
        },
        {
          subject: 'Why 8,400+ moms gave this 5 stars',
          body: 'We asked moms what matters most: durability, value, and ease of use. This ${product} checks all three. See the reviews →',
        },
        {
          subject: '"I wish I\'d bought this sooner" — real mom reviews',
          body: "The #1 thing moms say about this ${product}: \"I wish I hadn't waited.\" Here's why it's a household essential →",
        },
      ],
      abandoned: [
        {
          subject: 'Your ${product} is still here (and so is the discount)',
          body: "Hey mama! Your ${product} is waiting in your cart. We know budgets are tight — that's why we extended your 10% off for 24 more hours.",
        },
        {
          subject: 'What other moms said about this ${product}...',
          body: '3 moms who almost didn\'t buy it: "Best kitchen purchase this year" / "My kids actually use it" / "Saved me so much time." Complete your order →',
        },
        {
          subject: 'Free shipping added to your cart! 🚚',
          body: 'We added free shipping to your ${product} order. No minimum, no catch. Just click complete →',
        },
      ],
      postPurchase: [
        {
          subject: 'Your ${product} is on its way to your home! 📦',
          body: "Great news — your ${product} shipped! It'll arrive in 3-5 days. We included a quick-start guide perfect for busy moms.",
        },
        {
          subject: "How's the family loving it? 💛",
          body: "Hey! It's been a week — how's the ${product} working out for the family? If the kids love it too, we'd be so grateful for a quick review!",
        },
        {
          subject: 'Family bundle deal just for you 🎁',
          body: "Since you loved the ${product}, here's an exclusive: get our family bundle (3 bestsellers) for 30% off. Limited time →",
        },
      ],
    },
    'Alex Thompson': {
      welcome: [
        {
          subject: "you're in 🌿 here's your aesthetic starter pack",
          body: "welcome to the club. we curate sustainable finds that look incredible AND do good. your 10% code: VIBES10. let's make your space iconic.",
        },
        {
          subject: 'the ${product} that broke the internet (for real)',
          body: "6,200 people bought this last week. here's the TikTok that started it all + why it actually lives up to the hype →",
        },
        {
          subject: 'our sustainability promise 🌱',
          body: "we only stock products we'd actually buy. every ${product} is vetted for quality, sustainability, and aesthetic value. no greenwashing, ever.",
        },
      ],
      abandoned: [
        {
          subject: 'your cart is giving... abandoned aesthetic 🖤',
          body: "hey! your ${product} is waiting. we get it — decision fatigue is real. but this one's selling fast and the aesthetic is immaculate.",
        },
        {
          subject: 'the reviews are in... 📱',
          body: '500+ people bought this ${product} this week. their reviews: "the aesthetic is immaculate" / "sustainable AND cute?? yes please" / "not me ordering a second one"',
        },
        {
          subject: 'low stock alert 🚨 only 12 left',
          body: "the ${product} in your cart is almost gone. we restock monthly but this colorway won't come back. just saying 🤷",
        },
      ],
      postPurchase: [
        {
          subject: 'your ${product} shipped sustainably 🌿',
          body: 'your order is on its way! we used compostable packaging because... planet earth. track your order →',
        },
        {
          subject: 'show us your setup? 📸',
          body: "hey! we'd love to see your ${product} in your space. tag us @brand for a chance to be featured. aesthetic content only ✨",
        },
        {
          subject: 'friend code: give $10 get $10 🤝',
          body: 'share your unique code with friends and you both get $10 off. sustainability looks better with friends →',
        },
      ],
    },
  };
  ...
  const LandingPageBlueprint = [
    {
      ...
      priority: 'Must Have',
      details:
        'Full-width lifestyle photo, headline matching ad copy, CTA button above fold, trust badge (5-star rating)',
      copy: 'Use the winning ad headline here. Match the exact wording so the customer feels continuity from ad → landing page.',
    },
    {
      section: 'Social Proof Bar',
      priority: 'Must Have',
      details:
        '滚动 testimonial bar with 3-5 short quotes, star rating, total review count, "As seen on [platform]" badge',
      copy: 'Place immediately below hero. Numbers convert: "12,847 happy customers" beats "Many satisfied customers."',
    },
    {
      section: 'Problem-Agitate Section',
      priority: 'Must Have',
      details: '3-column grid showing common pain points this product solves, with relatable icons and short copy',
      copy: 'Mirror the fears from the persona profile. "Tired of [pain point]?" format works universally.',
    },
    {
      section: 'Product Demo Video',
      priority: 'High Value',
      details:
        '30-60 second product-in-use video, autoplay muted, shows transformation/result, no fancy editing needed',
      copy: 'UGC-style beats professional. Show real person using product, not a studio production. 15-second hook is critical.',
    },
    {
      section: 'Features & Benefits',
      priority: 'Must Have',
      details: 'Alternating left/right layout: feature icon + benefit headline + 1-line explanation. 4-6 features max.',
      copy: 'Benefits > Features. "Saves 30 minutes daily" beats "Has 5000mAh battery." Lead with what they GET, not what it HAS.',
    },
    {
      section: 'Before/After Gallery',
      priority: 'High Value',
      details:
        'Side-by-side comparison photos, user-submitted preferred, grid of 4-6 transformations, carousel on mobile',
      copy: 'The single highest-converting section for most products. Always use real photos. AI-enhanced OK but never fake.',
    },
    {
      section: 'Reviews Section',
      priority: 'Must Have',
      details:
        '5-star filter default, photo reviews first, "verified buyer" badge, sort by most helpful, show negative reviews too',
      copy: "Showing a few negative reviews (3-star) actually INCREASES trust. Only show ones you've responded to professionally.",
    },
    {
      section: 'Comparison Table',
      priority: 'High Value',
      details:
        'Your product vs 2-3 competitors/alternatives, checkmark grid, highlight your advantages, honest about tradeoffs',
      copy: 'Don\'t lie. If competitor is cheaper, say so: "Cheaper alternatives exist. This one lasts 3x longer."',
    },
    {
      section: 'FAQ Section',
      priority: 'Must Have',
      details:
        'Accordion-style, address top 5-7 objections from persona profile, include shipping/returns/warranty info',
      copy: 'Use the EXACT objection phrasing from the persona. "Will this actually work for ME?" as a heading converts.',
    },
    {
      section: 'Bundle / Upsell',
      priority: 'Optional',
      details: '"Frequently bought together" grid, bundle discount calculator, complementary product suggestions',
      copy: 'Show savings: "Bundle and save $15" is more compelling than "Add accessories." Calculator makes it tangible.',
    },
    {
      section: 'Urgency Elements',
      priority: 'Must Have',
      details:
        'Stock counter ("Only X left"), countdown timer for sales, "X people viewing now", recent purchase notifications',
      copy: 'Use real scarcity. Fake timers destroy trust. If sale ends, it ends. Authenticity > pressure.',
    },
    {
      section: 'Footer Trust',
      priority: 'Must Have',
      details: 'Payment icons, SSL badge, return policy summary, contact info, social media links, shipping info',
      copy: 'Every element answers one question: "Is this safe to buy?" Reduce friction at the final decision point.',
    },
  ];
  ...
  const PlatformStrategies = {
    'Sarah Mitchell': {
      facebook: {
        ...
        adTypes: ['Carousel (before/after)', 'Video (60s testimonial)', 'Collection ads', 'Lead gen forms'],
        targeting:
          'Women 28-44, interests: Home Organization + Beauty Tools, Engaged Shoppers, Lookalike from purchasers',
        creative:
          'Warm, relatable, "your friend telling you about this" vibe. Show real women, not models. Problem-first hook.',
        optimal: 'Run ads 7-10pm, increase budget Thu-Sun, retarget cart abandoners within 1 hour',
      },
      instagram: {
        budget: '30% of ad spend',
        adTypes: [
          'Reels (15-30s transformation)',
          'Stories (poll + swipe up)',
          'Carousel (lifestyle photos)',
          'Shopping posts',
        ],
        targeting: 'Women 25-40, interest: Lifestyle + Self-care, Instagram Shoppers, Engagement custom audience',
        creative:
          'Aesthetic, aspirational but achievable. Natural lighting, real homes. "That could be my bathroom" feel.',
        optimal: 'Post Reels 6-9pm, Stories daily, use 5-7 hashtags, engage with comments within 30min',
      },
      tiktok: {
        budget: '25% of ad spend',
        adTypes: [
          'In-Feed (15s problem→solution)',
          'Spark Ads (boost creator content)',
          'TopView (launch days)',
          'Shopping ads',
        ],
        targeting: 'Women 22-38, interest: Life Hacks + Product Reviews, Engaged with similar products',
        creative:
          'UGC-style, show the PROBLEM first (3s), then the product as hero. Trending audio. Hook in first 1 second.',
        optimal: 'Post 2-3x/day, best times 7-10pm, respond to comments with video, duet positive reviews',
      },
      youtube: {
        budget: '5% of ad spend',
        adTypes: ['Pre-roll skippable (15s hook)', 'Shorts (repurpose TikTok)', 'Long-form review placement'],
        targeting: 'In-market: Home + Kitchen, custom intent: product-related searches',
        creative: 'Review-style, "I tested this for 30 days" format. Longer format for high-ticket items only.',
        optimal: 'Target competitor product names as keywords, run Shorts repurposed from TikTok',
      },
    },
    'Jason Park': {
      facebook: {
        budget: '15% of ad spend',
        adTypes: ['Video review style', 'Single image (product on desk)', 'Collection (product ecosystem)'],
        targeting: 'Men 22-35, interests: Tech Gadgets + Gaming Setup, Tech Early Adopters, High online spend',
        creative: 'Tech-focused, specs-forward. Show the product in a real desk setup. Benchmark comparison overlay.',
        optimal: 'Run evenings 7-10pm, retarget YouTube viewers, test against Reddit audience',
      },
      instagram: {
        budget: '20% of ad spend',
        adTypes: ['Reels (unboxing/setup)', 'Carousel (spec comparison)', 'Stories (quick demo)', 'Shopping posts'],
        targeting: 'Men 20-32, interests: Tech + Gaming + EDC, Instagram Shopping engaged',
        creative:
          'Clean, minimal aesthetic. Product on dark desk background. Specs as text overlay. "Overengineered" feel.',
        optimal: 'Reels 3x/week, carousel for detailed specs, engage in tech comments',
      },
      tiktok: {
        budget: '35% of ad spend',
        adTypes: ['In-Feed (honest review)', 'Duet/Stitch (react to other reviews)', 'Spark Ads'],
        targeting: 'Men 18-30, interests: Tech Reviews + Gadget Unboxing, High engagement',
        creative: '"Honest review" format, show pros AND cons. Reddit energy. "No cap this slaps" authenticity.',
        optimal: 'Post 1-2x/day, reply to comments with video, stitch competitor reviews',
      },
      youtube: {
        budget: '30% of ad spend',
        adTypes: ['Pre-roll (spec-focused)', 'Sponsored reviews', 'Shorts (quick comparisons)'],
        targeting: 'Tech channels audience, custom intent: product searches, competitor product names',
        creative:
          'Detailed, specs-heavy. "I compared 5 ${product}s — here\'s the winner" format. Benchmark data on screen.',
        optimal: 'Sponsor 2-3 micro-tech channels, run pre-roll on review videos, Shorts for quick takes',
      },
    },
    'Maria Rodriguez': {
      facebook: {
        budget: '50% of ad spend',
        adTypes: ['Carousel (family use cases)', 'Video (mom testimonial)', 'Group posts', 'Collection ads'],
        targeting: 'Women 30-50, Parents with Young Children, interests: Mom Life + Budget Shopping, Engaged Shoppers',
        creative: 'Warm, trustworthy, "I\'m a mom too" feel. Show product in real family setting. Durability emphasis.',
        optimal: 'Run during nap time 1-3pm and bedtime 9-11pm, post in mom groups, retarget within 2 hours',
      },
      instagram: {
        budget: '15% of ad spend',
        adTypes: ['Reels (mom routine)', 'Stories (behind the scenes)', 'Carousel (family photos)'],
        targeting: 'Women 28-45, interests: Parenting + Home Organization, Instagram Shopping',
        creative:
          'Real family life, not staged. Show kids using it. "This is what 3pm chaos looks like before this product" before/after.',
        optimal: 'Stories daily (polls engage moms), Reels 3x/week, respond to DMs within 1 hour',
      },
      tiktok: {
        budget: '20% of ad spend',
        adTypes: ['In-Feed (mom hack)', 'MomTok content', 'Spark Ads (mom creator)'],
        targeting: 'Women 25-45, interests: MomTok + Parenting Tips + Family Hacks',
        creative: '"Mom hack" format, show the problem (messy kitchen) then the solution. Relatable, not aspirational.',
        optimal: 'Post during nap time, engage #MomTok, duet mom creators',
      },
      youtube: {
        budget: '15% of ad spend',
        adTypes: ['Mom blogger reviews', 'Pre-roll on parenting channels', 'Shorts (quick tips)'],
        targeting: 'Parenting channels, family vlogs, home organization content',
        creative:
          '"Honest mom review" format. Show the product lasting through real family use. Long-term update preferred.',
        optimal: 'Sponsor family/parenting channels, target back-to-school and holiday seasons harder',
      },
    },
    'Alex Thompson': {
      facebook: {
        budget: '10% of ad spend',
        adTypes: ['Reels (aesthetic reveal)', 'Carousel (lifestyle photos)', 'Collection (aesthetic bundle)'],
        targeting: 'Age 18-28, interests: Aesthetic Lifestyle + Sustainable Living, Mobile Buyers, Social Media Active',
        creative:
          'Aesthetic-first. Clean, minimal, Instagram-ready. Sustainability angle prominent. Color-coordinated.',
        optimal: 'Low budget, mostly retargeting. Use for lookalike audiences from TikTok purchasers.',
      },
      instagram: {
        budget: '25% of ad spend',
        adTypes: ['Reels (GRWM/aesthetic)', 'Stories (limited drops)', 'Carousel (flat lay)', 'Shopping posts'],
        targeting: 'Age 18-28, interests: Aesthetic + Sustainable + Art & Design, Instagram Shopping',
        creative:
          'Curated aesthetic. Every post should look like it belongs in a mood board. Sustainability stories highlighted.',
        optimal: 'Post 1-2x/day, Stories 3-5x/day, use aesthetic hashtags, engage with comment section',
      },
      tiktok: {
        budget: '55% of ad spend',
        adTypes: ['In-Feed (viral format)', 'Spark Ads (boost creators)', 'TopView (limited drops)', 'LIVE (unboxing)'],
        targeting: 'Age 16-24, interests: Aesthetic + Sustainable Finds + Haul + GRWM, High engagement, Share creators',
        creative:
          'Native TikTok energy. Show product in aesthetic space. "POV" format. Trending sounds. Authentic, not polished.',
        optimal: 'Post 2-4x/day, ride trends within 24 hours, reply to comments with video, go LIVE for drops',
      },
      youtube: {
        budget: '10% of ad spend',
        adTypes: ['Shorts (aesthetic reveals)', 'Creator collaborations', 'Aesthetic vlogs'],
        targeting: 'Lifestyle channels, room decor, sustainable living content',
        creative:
          '"Day in my life with [product]" format. Soft, aesthetic, ASMR-adjacent. Product feels like part of the lifestyle.',
        optimal: 'Collab with aesthetic YouTubers, repurpose TikTok as Shorts, target haul/GRWM content',
      },
    },
  };
  ...
  function findProduct(query, products) {
    ...
    const productKey =
      Object.keys(ProductPersonas).find(
        (k) => q.includes(k) || ProductPersonas[k].keywords?.some((kw) => q.includes(kw))
      ) ||
      match?.keywords?.[0] ||
      '';
  ...
  const CustomerPersonaPlugin = {
    ...
    init(_ctx) {
      Config.defaults('customerPersona', { enabled: true });
    },
    ...
    mount(_ctx) {
      ...
      ${window.HuntDrop.renderRelatedTools([
        ...
        { section: 'section-calendar', name: 'Content Calendar', desc: 'Plan content', icon: '📅', color: '#00e5ff' },
        {
          ...
          desc: "Analyze competitors' audiences",
          icon: '⚔️',
          color: '#ff3366',
        },
      ])}`;
    ...
    const stages = [
      {
        icon: '👀',
        title: 'Awareness',
        desc: 'They scroll TikTok/Instagram and see a creator using this product',
        color: 'var(--accent-purple)',
        actions: [
          'See a creator mention it in a GRWM video',
          'Friend shares a link in group chat',
          'Ad appears in Stories/Reels feed',
          'Browse Reddit and see a recommendation',
        ],
      },
      {
        icon: '🔍',
        title: 'Research',
        desc: 'They Google it, check reviews, compare alternatives',
        color: 'var(--accent-cyan)',
        actions: [
          'Google "[product] review" and read 3+ sources',
          'Watch YouTube unboxing/comparison',
          'Read Amazon reviews (focus on 3-star for balance)',
      ...
      },
      {
        icon: '🤔',
        title: 'Consideration',
        desc: 'They weigh the cost vs. benefit, battle objections internally',
        color: 'var(--accent-orange)',
        actions: [
          'Ask themselves "Do I really need this?"',
          'Compare to known brands (AirPods, Dyson, etc.)',
          'Calculate cost-per-use in their head',
          "Check if there's a return policy",
          'Look for coupon codes or wait for sale',
        ],
      },
      {
        icon: '💳',
        title: 'Purchase',
        desc: 'Something tips them over — a discount, social proof, or urgency',
        color: 'var(--accent-green)',
        actions: [
          'See "only 3 left" or countdown timer',
          'Read one more glowing review that seals it',
          'Find a 10% off coupon code',
          'Free shipping threshold pushes them',
          'Apple Pay makes checkout instant',
        ],
      },
      {
        icon: '📦',
        title: 'Post-Purchase',
        desc: "Unboxing, using, and deciding if they'll buy again or recommend",
        color: 'var(--accent-pink)',
        actions: [
          'Take photos/videos for social media',
          'Decide within 30 seconds if quality matches expectations',
          'Leave a review (if exceptional or terrible)',
          'Tell friends or post about it',
          "Return if it doesn't match the ad promise",
        ],
      },
    ];
  ...
  function renderLanguage(personas, product) {
    ...
    const allTriggers = [
      ...new Set([...personas.flatMap((p) => p.buyingTriggers), ...(product.extraData?.triggers || [])]),
    ].slice(0, 10);
    const allObjections = [
      ...new Set([...personas.flatMap((p) => p.objections), ...(product.extraData?.objections || [])]),
    ].slice(0, 8);
  ...
  function renderCheckout(personas, _product) {
    ...
    const allWindows = personas.map((p) => ({
      best: p.purchaseWindow.best,
      worst: p.purchaseWindow.worst,
      seasonal: p.purchaseWindow.seasonal,
    }));
  ...
  function renderDemographics(personas, _product) {
    ...
    const demoData = [
      ...
      },
      {
        ...
        platforms: 'FB/YouTube/Pinterest',
        devices: '65% Mobile',
        peak: 'Nap time 1-3pm',
        avgOrder: '$25',
        ltv: '$85',
