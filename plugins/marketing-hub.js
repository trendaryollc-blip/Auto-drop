...
(function () {
  ...
  function bindEvents() {
    ...
    if (genBtn) genBtn.addEventListener('click', () => generateAd());

    const budgetInput = document.getElementById('mhBudget');
    if (budgetInput) budgetInput.addEventListener('input', () => updateBudget());
