...
(function () {
  ...
  const DEMO_STORES = [
    {
      ...
      socialIG: 67000,
      socialTK: 134000,
      trafficSources: { direct: 18, organic: 32, paid: 25, social: 18, referral: 7 },
      topCountries: ['US', 'UK', 'CA'],
      apps: ['Klaviyo', 'Oberlo', 'Loox', 'Privy'],
      refundRate: 2.1,
    },
    {
      id: 's2',
      name: 'Glow Essentials',
      url: 'glowessentials.myshopify.com',
      platform: 'Shopify',
      theme: 'Refresh',
      avatar: 'G',
      color: '#ec4899',
      ...
      socialIG: 156000,
      socialTK: 289000,
      trafficSources: { direct: 22, organic: 35, paid: 28, social: 12, referral: 3 },
      topCountries: ['US', 'AU', 'UK'],
      apps: ['Klaviyo', 'Judge.me', 'Vitals', 'PageFly'],
      refundRate: 1.8,
    },
    {
      id: 's3',
      name: 'FitVault Pro',
      url: 'fitvault.myshopify.com',
      platform: 'Shopify',
      theme: 'Dawn',
      avatar: 'F',
      color: '#f97316',
      ...
      socialIG: 34000,
      socialTK: 78000,
      trafficSources: { direct: 15, organic: 28, paid: 32, social: 18, referral: 7 },
      topCountries: ['US', 'CA', 'DE'],
      apps: ['Oberlo', 'Klaviyo', 'Smile.io'],
      refundRate: 3.5,
    },
    {
      id: 's4',
      ...
      socialIG: 89000,
      socialTK: 198000,
      trafficSources: { direct: 20, organic: 30, paid: 22, social: 23, referral: 5 },
      topCountries: ['US', 'JP', 'UK'],
      apps: ['Klaviyo', 'Loox', 'Oberlo', 'Privy'],
      refundRate: 2.4,
    },
    {
      id: 's5',
      name: 'TechDrop Hub',
      url: 'techdrop.myshopify.com',
      platform: 'Shopify',
      theme: 'Dawn',
      avatar: 'T',
      color: '#ef4444',
      ...
      socialIG: 112000,
      socialTK: 245000,
      trafficSources: { direct: 25, organic: 22, paid: 35, social: 14, referral: 4 },
      topCountries: ['US', 'UK', 'DE'],
      apps: ['Klaviyo', 'Oberlo', 'Vitals', 'AliReviews'],
      refundRate: 4.2,
    },
    {
      id: 's6',
      name: 'PostureTech',
      url: 'posturetech.myshopify.com',
      platform: 'Shopify',
      theme: 'Refresh',
      avatar: 'P',
      color: '#06b6d4',
      age: '5 months',
      category: 'Ergonomic Products',
      revenue: 34700,
      traffic: 56000,
      convRate: 3.5,
      products: 45,
      ...
      socialIG: 23000,
      socialTK: 56000,
      trafficSources: { direct: 16, organic: 38, paid: 20, social: 19, referral: 7 },
      topCountries: ['US', 'CA', 'AU'],
      apps: ['Klaviyo', 'Judge.me', 'Loox'],
      refundRate: 1.9,
    },
    {
      id: 's7',
      name: 'NomadStyle',
      url: 'nomadstyle.myshopify.com',
      platform: 'Shopify',
      theme: 'Sense',
      avatar: 'N',
      color: '#eab308',
      ...
      socialIG: 234000,
      socialTK: 412000,
      trafficSources: { direct: 28, organic: 33, paid: 24, social: 13, referral: 2 },
      topCountries: ['US', 'UK', 'FR'],
      apps: ['Klaviyo', 'Oberlo', 'Loox', 'Smile.io', 'PageFly'],
      refundRate: 2.8,
    },
    {
      id: 's8',
      name: 'ZenSpace Co',
      url: 'zenspace.myshopify.com',
      platform: 'Shopify',
      theme: 'Dawn',
      avatar: 'Z',
      color: '#10b981',
      ...
      socialIG: 78000,
      socialTK: 167000,
      trafficSources: { direct: 19, organic: 34, paid: 21, social: 19, referral: 7 },
      topCountries: ['US', 'CA', 'UK'],
      apps: ['Klaviyo', 'Judge.me', 'Privy', 'Vitals'],
      refundRate: 2.0,
    },
    {
      id: 's9',
      name: 'WildRider',
      url: 'wildrider.myshopify.com',
      platform: 'Shopify',
      theme: 'Refresh',
      avatar: 'W',
      color: '#f43f5e',
      ...
      socialIG: 95000,
      socialTK: 201000,
      trafficSources: { direct: 17, organic: 29, paid: 30, social: 18, referral: 6 },
      topCountries: ['US', 'AU', 'CA'],
      apps: ['Klaviyo', 'Oberlo', 'Loox', 'Smile.io'],
      refundRate: 3.1,
    },
    {
      id: 's10',
      name: 'LittleLux',
      url: 'littlelux.myshopify.com',
      platform: 'Shopify',
      theme: 'Sense',
      avatar: 'L',
      color: '#6366f1',
      ...
      socialIG: 178000,
      socialTK: 323000,
      trafficSources: { direct: 21, organic: 36, paid: 23, social: 15, referral: 5 },
      topCountries: ['US', 'UK', 'CA'],
      apps: ['Klaviyo', 'Judge.me', 'Loox', 'Oberlo', 'Privy'],
      refundRate: 2.3,
    },
  ];
  ...
  const DEMO_ADS = [
    {
      ...
      hook: 'Your cat will be OBSESSED for hours',
      ctr: 4.8,
      spend: 120,
      status: 'scaling',
      age: 45,
      ...
      engagement: '12.4K likes · 3.2K shares',
    },
    {
      store: 'Pawfect Picks',
      platform: 'TikTok',
      product: 'Self-Cleaning Pet Brush',
      hook: 'Watch the fur come off in seconds',
      ctr: 6.2,
      spend: 200,
      status: 'scaling',
      age: 32,
      format: 'Spark Ad',
      objective: 'Traffic',
      engagement: '45.6K views · 8.9K likes',
    },
    {
      store: 'Glow Essentials',
      platform: 'Facebook',
      ...
      format: 'Carousel',
      objective: 'Conversions',
      engagement: '23.1K likes · 5.6K comments',
    },
    {
      store: 'Glow Essentials',
      platform: 'Instagram',
      product: 'Collagen Serum',
      hook: 'Age 25? Start this NOW before its too late',
      ctr: 3.9,
      spend: 95,
      status: 'running',
      age: 28,
      ...
      engagement: '8.9K likes · 1.2K saves',
    },
    {
      store: 'FitVault Pro',
      platform: 'TikTok',
      product: 'Resistance Band Set',
      hook: 'Full gym workout in your living room',
      ctr: 5.7,
      spend: 150,
      status: 'scaling',
      age: 21,
      format: 'Spark Ad',
      objective: 'Conversions',
      engagement: '67.8K views · 15.3K likes',
    },
    {
      store: 'Kawaii Decor',
      platform: 'Facebook',
      product: 'LED Neon Sign',
      hook: 'Transform your room in 60 seconds',
      ctr: 4.2,
      spend: 85,
      status: 'running',
      age: 35,
      format: 'Video 9:16',
      objective: 'Traffic',
      engagement: '9.8K likes · 2.1K shares',
    },
    {
      store: 'Kawaii Decor',
      platform: 'Instagram',
      product: 'Cloud Lamp',
      hook: 'The coziest corner starts here',
      ctr: 3.5,
      spend: 65,
      status: 'testing',
      age: 14,
      ...
      engagement: '4.3K likes · 890 comments',
    },
    {
      store: 'TechDrop Hub',
      platform: 'Facebook',
      ...
      format: 'Video 1:1',
      objective: 'Conversions',
      engagement: '34.5K likes · 7.8K shares',
    },
    {
      store: 'PostureTech',
      platform: 'TikTok',
      product: 'Posture Corrector',
      hook: 'Fixed my back pain in 2 weeks',
      ctr: 7.1,
      spend: 180,
      status: 'scaling',
      age: 28,
      format: 'Spark Ad',
      objective: 'Conversions',
      engagement: '89.2K views · 21.4K likes',
    },
    {
      store: 'PostureTech',
      platform: 'Facebook',
      product: 'Standing Desk Mat',
      hook: 'Your back will thank you later',
      ctr: 4.4,
      spend: 90,
      status: 'running',
      age: 19,
      format: 'Carousel',
      objective: 'Traffic',
      engagement: '5.6K likes · 1.3K comments',
    },
    {
      store: 'NomadStyle',
      platform: 'Facebook',
      product: 'Minimalist Watch',
      hook: 'The only watch you will ever need',
      ctr: 4.7,
      spend: 160,
      status: 'scaling',
      age: 67,
      format: 'Video 1:1',
      objective: 'Conversions',
      engagement: '28.9K likes · 6.7K shares',
    },
    {
      store: 'NomadStyle',
      platform: 'Instagram',
      product: 'Leather Card Holder',
      hook: 'Slim. Premium. Effortless.',
      ctr: 3.8,
      spend: 75,
      status: 'running',
      age: 41,
      format: 'Reels',
      objective: 'Brand Awareness',
      engagement: '11.2K likes · 2.8K saves',
    },
    {
      store: 'ZenSpace Co',
      platform: 'TikTok',
      product: 'Aromatherapy Diffuser',
      hook: 'Turn your room into a 5-star spa',
      ctr: 5.3,
      spend: 110,
      status: 'running',
      age: 24,
      format: 'Spark Ad',
      objective: 'Traffic',
      engagement: '34.5K views · 7.8K likes',
    },
    {
      store: 'WildRider',
      platform: 'Facebook',
      product: 'Portable Hammock',
      hook: 'Camp anywhere in 30 seconds flat',
      ctr: 4.1,
      spend: 95,
      status: 'testing',
      age: 17,
      format: 'Video 9:16',
      objective: 'Conversions',
      engagement: '6.7K likes · 1.4K shares',
    },
    {
      store: 'WildRider',
      platform: 'TikTok',
      product: 'Solar Power Bank',
      hook: 'Never run out of battery again',
      ctr: 5.8,
      spend: 140,
      status: 'scaling',
      age: 31,
      format: 'Spark Ad',
      objective: 'Traffic',
      engagement: '52.1K views · 12.3K likes',
    },
    {
      store: 'LittleLux',
      platform: 'Facebook',
      product: 'Baby Sleep Suit',
      hook: 'Sleeping through the night guaranteed',
      ctr: 6.4,
      spend: 170,
      status: 'scaling',
      age: 38,
      format: 'Video 1:1',
      objective: 'Conversions',
      engagement: '19.8K likes · 4.5K comments',
    },
    {
      store: 'LittleLux',
      platform: 'Instagram',
      product: 'Organic Baby Set',
      hook: 'Pure ingredients only',
      ctr: 3.6,
      spend: 55,
      status: 'testing',
      age: 12,
      format: 'Story',
      objective: 'Engagement',
      engagement: '3.2K likes · 670 saves',
    },
    {
      store: 'Glow Essentials',
      platform: 'TikTok',
      product: 'Hair Growth Oil',
      hook: 'My hair grew 3 inches in 1 month',
      ctr: 8.2,
      spend: 300,
      status: 'scaling',
      age: 44,
      format: 'Spark Ad',
      objective: 'Conversions',
      engagement: '112K views · 34.5K likes',
    },
    {
      store: 'FitVault Pro',
      platform: 'Facebook',
      product: 'Ab Roller Wheel',
      hook: '6-pack in 30 days challenge',
      ctr: 4.9,
      spend: 80,
      status: 'running',
      age: 16,
      format: 'Carousel',
      objective: 'Traffic',
      engagement: '7.8K likes · 2.1K shares',
    },
    {
      store: 'TechDrop Hub',
      platform: 'TikTok',
      product: 'Phone Gimbal Stabilizer',
      hook: 'Cinematic video from your phone',
      ctr: 5.5,
      spend: 190,
      status: 'scaling',
      age: 37,
      format: 'Spark Ad',
      objective: 'Conversions',
      engagement: '78.4K views · 18.9K likes',
    },
  ];
  ...
  function getAdsForStore(storeName) {
    return DEMO_ADS.filter(function (a) {
      return a.store === storeName || a.competitor === storeName;
    });
  }

  function getChangesForStore(storeName) {
    return PRICE_CHANGES.filter(function (p) {
      return p.store === storeName || p.competitor === storeName;
    });
  }

  function getProductsForStore(storeName) {
    return NEW_PRODUCTS.filter(function (np) {
      return np.store === storeName || np.competitor === storeName;
    });
  }
  ...
  function renderLeaderboard() {
    ...
    var sorted = [].concat(STORES).sort(function (a, b) {
    ...
    sorted.forEach(function (s, i) {
      ...
      h +=
        ...
        esc(s.id) +
        '">' +
        '<span class="spy-lb-medal">' +
        medal +
        '</span>' +
        '<span class="spy-lb-dot" style="background:' +
        s.color +
        '"></span>' +
        '<div class="spy-lb-info"><div class="spy-lb-name">' +
        esc(s.name) +
        '</div><div class="spy-lb-cat">' +
        esc(s.category) +
        '</div></div>' +
        '<div class="spy-lb-stats">' +
        '<span class="spy-lb-stat"><span class="spy-lb-stat-label">Revenue</span><span class="spy-lb-stat-val" style="color:var(--accent-green)">' +
        fmtMoney(s.revenue) +
        '/mo</span></span>' +
        '<span class="spy-lb-stat"><span class="spy-lb-stat-label">Conv</span><span class="spy-lb-stat-val">' +
        s.convRate +
        '%</span></span>' +
        '<span class="spy-lb-stat"><span class="spy-lb-stat-label">Traffic</span><span class="spy-lb-stat-val">' +
        fmtNum(s.traffic) +
        '</span></span>' +
        '<span class="spy-lb-stat"><span class="spy-lb-stat-label">AOV</span><span class="spy-lb-stat-val">$' +
        s.aov +
        '</span></span>' +
        '<span class="spy-lb-stat"><span class="spy-lb-stat-label">Ads</span><span class="spy-lb-stat-val">' +
        s.ads +
        '</span></span>' +
        '</div>' +
        '</div>';
  ...
  function renderPricing() {
    ...
    changes.forEach(function (p) {
      ...
      h +=
        '<div class="spy-price-item">' +
        '<span class="spy-price-store" style="color:' +
        (store ? store.color : 'var(--text-muted)') +
        '">' +
        esc(p.store || p.competitor) +
        '</span>' +
        '<span class="spy-price-product">' +
        esc(p.product) +
        '</span>' +
        ...
        '</span>' +
        '<span class="spy-price-change" style="color:' +
        (isDown ? 'var(--accent-green)' : 'var(--accent-red)') +
        '">' +
        (isDown ? '' : '+') +
        p.change +
    ...
    h += '</div></div>';
    h +=
      '<div class="spy-pricing-insights"><h3 class="spy-section-title">\ud83d\udca1 Pricing Insights</h3><div class="spy-pricing-cards">';
    h +=
      '<div class="spy-insight-card"><div class="spy-insight-val" style="color:var(--accent-green)">' +
      changes.filter(function (p) {
        return p.change < 0;
      }).length +
      '</div><div class="spy-insight-label">Price Drops</div><div class="spy-insight-sub">Competitors cutting prices</div></div>';
    h +=
      '<div class="spy-insight-card"><div class="spy-insight-val" style="color:var(--accent-red)">' +
      changes.filter(function (p) {
        return p.change > 0;
      }).length +
      '</div><div class="spy-insight-label">Price Increases</div><div class="spy-insight-sub">Potential opportunity</div></div>';
    var avgChange = changes.length
      ? (
          changes.reduce(function (a, p) {
            return a + p.change;
          }, 0) / changes.length
        ).toFixed(1)
      : '0';
    h +=
      '<div class="spy-insight-card"><div class="spy-insight-val" style="color:var(--accent-cyan)">' +
      avgChange +
      '%</div><div class="spy-insight-label">Avg Change</div><div class="spy-insight-sub">Across all products</div></div>';
    h += '</div></div>';
    return h + '</div></div>';
  }
  ...
  function renderTechStack() {
    ...
    STORES.forEach(function (s) {
      ...
      h +=
        ...
        esc(s.theme) +
        '</div></div>' +
        '<div class="spy-tech-age">' +
        esc(s.age) +
        ' old</div></div>' +
        '<div class="spy-tech-apps">' +
        s.apps
          .map(function (a) {
            return '<span class="spy-tech-app">' + esc(a) + '</span>';
          })
          .join('') +
        '</div>' +
  ...
  function renderTraffic() {
    if (!STORES.length) return '<div class="spy-empty-state">No store data available.</div>';
    var h =
      '<div class="spy-traffic-section"><h3 class="spy-section-title">\ud83c\udf10 Traffic Sources &amp; Social Presence</h3>';
    STORES.forEach(function (s) {
      h +=
        '<div class="spy-traffic-card"><div class="spy-traffic-header"><span class="spy-traffic-avatar" style="background:' +
        s.color +
        '22;color:' +
        s.color +
        '">' +
        esc(s.avatar) +
        '</span><span class="spy-traffic-name">' +
        esc(s.name) +
        '</span></div>';
      ...
      ['direct', 'organic', 'paid', 'social', 'referral'].forEach(function (k) {
        var colors = {
          ...
          paid: 'var(--accent-orange)',
          social: 'var(--accent-pink)',
          referral: 'var(--accent-purple)',
        };
        h +=
          '<div class="spy-traffic-bar"><span class="spy-traffic-bar-label">' +
          k.charAt(0).toUpperCase() +
          k.slice(1) +
          '</span><div class="spy-tech-bar" style="flex:1"><div class="spy-tech-bar-fill" style="width:' +
          s.trafficSources[k] +
          '%;background:' +
          colors[k] +
          '"></div></div><span class="spy-traffic-bar-val">' +
          s.trafficSources[k] +
          '%</span></div>';
      });
      h += '</div>';
      h +=
        '<div class="spy-traffic-social"><span class="spy-social-icon fb">f</span><span>' +
        fmtNum(s.socialFB) +
        '</span><span class="spy-social-icon ig">\u25ce</span><span>' +
        fmtNum(s.socialIG) +
        '</span><span class="spy-social-icon tk">\u266a</span><span>' +
        fmtNum(s.socialTK) +
        '</span></div>';
      h += '</div>';
    });
  ...
  function renderNewProducts() {
    ...
    products.forEach(function (np) {
      ...
      var scoreColor =
        np.potentialScore >= 85
          ? 'var(--accent-green)'
          : np.potentialScore >= 70
            ? 'var(--accent-orange)'
            : 'var(--accent-red)';
      var trendIcon = np.trend === 'Hot' ? '\ud83d\udd25' : np.trend === 'Rising' ? '\ud83d\udcc8' : '\u26aa';
      h +=
        '<div class="spy-new-card">' +
        '<div class="spy-new-header"><span class="spy-new-category">' +
        esc(np.category) +
        '</span><span class="spy-new-trend">' +
        trendIcon +
        ' ' +
        esc(np.trend) +
        '</span></div>' +
        '<div class="spy-new-name">' +
        esc(np.name) +
        '</div>' +
        '<div class="spy-new-price">$' +
        np.price.toFixed(2) +
        '</div>' +
        '<div class="spy-new-score"><span class="spy-new-score-bar"><span class="spy-new-score-fill" style="width:' +
        np.potentialScore +
        '%;background:' +
        scoreColor +
        '"></span></span><span class="spy-new-score-val" style="color:' +
        scoreColor +
        '">' +
        np.potentialScore +
        '/100</span></div>' +
        (store
          ? '<div class="spy-new-store"><span class="spy-ad-store-dot" style="background:' +
            store.color +
            '"></span>' +
            esc(store.name) +
            '</div>'
  ...
  function drawRevenueChart() {
    ...
    var revenues = sorted.map(function (s) {
      return s.revenue;
    });
    var computedColors = [
      '#10b981',
  ...
  function renderTab(tab) {
    ...
    switch (tab) {
      ...
      case 'pricing':
        ...
        break;
      case 'techstack':
        html = renderTechStack();
        break;
      case 'traffic':
        html = renderTraffic();
        break;
      case 'newproducts':
        html = renderNewProducts();
        break;
      case 'revenue':
        html = renderRevenue();
        break;
  ...
  function showStoreProfile(storeId) {
    ...
    html +=
      '<div class="spy-profile-header"><div class="spy-profile-avatar" style="background:' +
      store.color +
      '22;color:' +
      store.color +
      '">' +
      esc(store.avatar) +
      '</div><div><div class="spy-profile-name">' +
      esc(store.name) +
      '</div><div class="spy-profile-url">' +
      esc(store.url) +
      '</div></div><button class="spy-profile-close" id="spyCloseBtn">\u2715</button></div>';
    html += '<div class="spy-profile-stats">';
    html +=
      '<div class="spy-profile-stat"><span class="spy-profile-stat-val" style="color:var(--accent-green)">' +
      fmtMoney(store.revenue) +
      '</span><span class="spy-profile-stat-label">Monthly Revenue</span></div>';
    html +=
      '<div class="spy-profile-stat"><span class="spy-profile-stat-val">' +
      store.convRate +
      '%</span><span class="spy-profile-stat-label">Conversion</span></div>';
    html +=
      '<div class="spy-profile-stat"><span class="spy-profile-stat-val" style="color:var(--accent-cyan)">' +
      fmtNum(store.traffic) +
      '</span><span class="spy-profile-stat-label">Monthly Traffic</span></div>';
    html +=
      '<div class="spy-profile-stat"><span class="spy-profile-stat-val">$' +
      store.aov +
      '</span><span class="spy-profile-stat-label">Avg Order</span></div>';
    html += '</div>';
    ...
    if (storeAds.length) {
      ...
      storeAds.forEach(function (a) {
        html +=
          '<div class="spy-profile-ad"><span class="spy-ad-platform">' +
          esc(a.platform) +
          '</span><span class="spy-ad-product">' +
          esc(a.product) +
          '</span><span style="color:var(--accent-cyan)">CTR ' +
          a.ctr +
          '%</span></div>';
      });
      html += '</div></div>';
    ...
    if (storeChanges.length) {
      ...
      storeChanges.forEach(function (p) {
        ...
        html +=
          ...
          esc(p.product) +
          '</span><span style="text-decoration:line-through;color:var(--text-muted)">$' +
          p.oldPrice.toFixed(2) +
          '</span><span>\u2192</span><span style="color:var(--accent-green);font-weight:600">$' +
          p.newPrice.toFixed(2) +
          '</span><span style="color:var(--accent-green);font-size:11px">' +
          sign +
          p.change +
          '%</span></div>';
      });
    ...
    html +=
      '<div class="spy-profile-section"><h4><span>\ud83d\udcca</span> Performance</h4><div class="spy-profile-perf">' +
      '<div class="spy-profile-perf-row"><span>Page Speed</span><span style="color:' +
      (store.pageSpeed >= 80 ? 'var(--accent-green)' : 'var(--accent-orange)') +
      '">' +
      store.pageSpeed +
      '/100</span></div>' +
      '<div class="spy-profile-perf-row"><span>SEO Score</span><span style="color:' +
      (store.seoScore >= 75 ? 'var(--accent-green)' : 'var(--accent-orange)') +
      '">' +
      store.seoScore +
      '/100</span></div>' +
      '<div class="spy-profile-perf-row"><span>Bounce Rate</span><span style="color:' +
      (store.bounceRate <= 35 ? 'var(--accent-green)' : 'var(--accent-orange)') +
      '">' +
      store.bounceRate +
      '%</span></div>' +
      '<div class="spy-profile-perf-row"><span>Avg Session</span><span>' +
      esc(store.avgSession) +
      '</span></div>' +
      '<div class="spy-profile-perf-row"><span>Refund Rate</span><span style="color:' +
      (store.refundRate <= 3 ? 'var(--accent-green)' : 'var(--accent-orange)') +
      '">' +
      store.refundRate +
      '%</span></div>' +
      '</div></div>';
    ...
    html +=
      ...
      '<div class="spy-profile-perf-row"><span>Top Country</span><span style="color:var(--accent-cyan)">' +
      esc(store.topCountries[0] || 'US') +
      '</span></div>' +
      '<div class="spy-profile-perf-row"><span>All Countries</span><span>' +
      esc(store.topCountries.join(', ')) +
      '</span></div>' +
      '<div class="spy-profile-perf-row"><span>Category</span><span>' +
      esc(store.category) +
      '</span></div>' +
      '<div class="spy-profile-perf-row"><span>Active Ads</span><span>' +
      store.ads +
      '</span></div>' +
      '</div></div>';
  ...
  function updateOverviewCards() {
    if (!_section) return;
    var totalRevenue = STORES.reduce(function (a, s) {
      return a + s.revenue;
    }, 0);
    var totalProducts = STORES.reduce(function (a, s) {
      return a + s.products;
    }, 0);
    var avgConv = STORES.length
      ? (
    ...
    mount: function (_ctx) {
      ...
      function doSearch() {
        ...
        if (store) {
          ...
          if (content)
            content.innerHTML = '<div class="spy-empty-state">No store found matching "' + esc(q) + '"</div>';
        }
      }
