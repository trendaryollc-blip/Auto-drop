    ...
    suppliers = [
      {
        ...
        verified: true,
        price: product?.price ? (product.price * 0.4).toFixed(2) : '8.50',
        riskScore: 92,
      },
      {
        id: 2,
        ...
        verified: true,
        price: product?.price ? (product.price * 0.35).toFixed(2) : '7.20',
        riskScore: 85,
      },
      {
        id: 3,
        ...
        verified: false,
        price: product?.price ? (product.price * 0.3).toFixed(2) : '6.80',
        riskScore: 68,
      },
    ];

    if (count) count.textContent = `${suppliers.length} suppliers`;
