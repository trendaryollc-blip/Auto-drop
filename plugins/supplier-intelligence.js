...
const SUPPLIER_DATABASE = [
  {name:"TechGear Direct",platform:"AliExpress",location:"Shenzhen, CN",rating:4.9,orders:"120K",responseTime:"< 2h",verified:true,specialty:"Electronics & Gadgets",responseRate:96,disputeRate:0.8,fulfillmentRate:98.5,yearsActive:6,color:"var(--accent-cyan)",products:342,shipTime:"7-15 days",shipCost:"$2-5",minOrder:"$50",quality:95,communication:92,value:88,topProducts:["Wireless Earbuds","Smart Watch","Phone Holder","LED Strip Lights","Bluetooth Speaker"]},
  {name:"SmartHome US",platform:"Amazon",location:"Dallas, US",rating:4.7,orders:"200K",responseTime:"< 1h",verified:true,specialty:"Smart Home Devices",responseRate:99,disputeRate:0.5,fulfillmentRate:99.2,yearsActive:4,color:"var(--accent-orange)",products:156,shipTime:"2-5 days",shipCost:"Free Prime",minOrder:"$0",quality:90,communication:96,value:82,topProducts:["Smart Plug","WiFi Camera","Smart Light","Voice Assistant","Door Sensor"]},
  {name:"PetEase Supplies",platform:"AliExpress",location:"Yiwu, CN",rating:4.8,orders:"95K",responseTime:"< 3h",verified:true,specialty:"Pet Products",responseRate:93,disputeRate:1.2,fulfillmentRate:97.8,yearsActive:5,color:"var(--accent-green)",products:228,shipTime:"8-18 days",shipCost:"$1-4",minOrder:"$30",quality:88,communication:85,value:92,topProducts:["Pet Camera","Dog Collar","Cat Toy","Pet Feeder","Grooming Kit"]},
  {name:"BeautyGlow Co",platform:"CJ Dropshipping",location:"Yiwu, CN",rating:4.6,orders:"400K",responseTime:"< 1h",verified:true,specialty:"Beauty & Health",responseRate:97,disputeRate:1.8,fulfillmentRate:96.5,yearsActive:7,color:"var(--accent-pink)",products:567,shipTime:"5-12 days",shipCost:"$1-3",minOrder:"$0",quality:86,communication:94,value:90,topProducts:["Facial Device","Hair Remover","Massage Gun","Skincare Set","Makeup Mirror"]},
  {name:"StarLight Tech",platform:"DHgate",location:"Shenzhen, CN",rating:4.9,orders:"200K",responseTime:"< 1h",verified:true,specialty:"LED & Lighting",responseRate:98,disputeRate:0.6,fulfillmentRate:99.1,yearsActive:8,color:"var(--accent-purple)",products:189,shipTime:"6-14 days",shipCost:"$2-6",minOrder:"$100",quality:94,communication:91,value:85,topProducts:["LED Galaxy Projector","Star Light","Strip Lights","Night Light","Lamp"]},
  {name:"PawWalk USA",platform:"Amazon",location:"Los Angeles, US",rating:4.7,orders:"110K",responseTime:"< 1h",verified:true,specialty:"Pet Accessories",responseRate:99,disputeRate:0.4,fulfillmentRate:99.5,yearsActive:3,color:"var(--accent-yellow)",products:94,shipTime:"1-4 days",shipCost:"Free Prime",minOrder:"$0",quality:92,communication:97,value:80,topProducts:["Dog Harness","Pet Carrier","Dog Bed","Cat Tree","Water Fountain"]},
  {name:"FitGear Pro",platform:"Temu",location:"Yiwu, CN",rating:4.7,orders:"320K",responseTime:"< 1h",verified:true,specialty:"Fitness Equipment",responseRate:95,disputeRate:1.5,fulfillmentRate:97.2,yearsActive:5,color:"var(--accent-red)",products:445,shipTime:"7-14 days",shipCost:"Free",minOrder:"$0",quality:82,communication:88,value:95,topProducts:["Resistance Bands","Yoga Mat","Massage Gun","Jump Rope","Dumbbells"]},
  {name:"PostureTech",platform:"TikTok Shop",location:"Shenzhen, CN",rating:4.9,orders:"90K",responseTime:"< 1h",verified:true,specialty:"Ergonomic Products",responseRate:97,disputeRate:0.7,fulfillmentRate:98.8,yearsActive:4,color:"var(--accent-cyan)",products:128,shipTime:"5-10 days",shipCost:"$1-3",minOrder:"$20",quality:93,communication:90,value:87,topProducts:["Neck Corrector","Back Support","Desk Organizer","Foot Massager","Eye Massager"]},
  {name:"KitchenWiz",platform:"AliExpress",location:"Ningbo, CN",rating:4.8,orders:"70K",responseTime:"< 2h",verified:true,specialty:"Kitchen Gadgets",responseRate:94,disputeRate:1.1,fulfillmentRate:97.5,yearsActive:6,color:"var(--accent-orange)",products:267,shipTime:"8-16 days",shipCost:"$2-5",minOrder:"$50",quality:89,communication:86,value:91,topProducts:["Air Fryer","Food Chopper","Coffee Maker","Knife Set","Storage Containers"]},
  {name:"ChargeTech",platform:"DHgate",location:"Shenzhen, CN",rating:4.7,orders:"100K",responseTime:"< 2h",verified:true,specialty:"Phone Accessories",responseRate:95,disputeRate:0.9,fulfillmentRate:98.0,yearsActive:5,color:"var(--accent-purple)",products:178,shipTime:"6-12 days",shipCost:"$2-4",minOrder:"$80",quality:91,communication:88,value:86,topProducts:["Car Mount","Wireless Charger","Phone Case","Screen Protector","Cable Set"]},
  {name:"CleanTech Labs",platform:"Temu",location:"Shenzhen, CN",rating:4.6,orders:"45K",responseTime:"< 3h",verified:true,specialty:"Cleaning Products",responseRate:91,disputeRate:2.0,fulfillmentRate:96.0,yearsActive:3,color:"var(--accent-cyan)",products:56,shipTime:"7-14 days",shipCost:"Free",minOrder:"$0",quality:80,communication:84,value:93,topProducts:["Vacuum Cleaner","Mop Set","Cleaning Spray","Organizer","Air Purifier"]},
  {name:"GlowDecor",platform:"Etsy",location:"Shenzhen, CN",rating:4.8,orders:"65K",responseTime:"< 2h",verified:true,specialty:"Home Decor",responseRate:93,disputeRate:1.0,fulfillmentRate:97.8,yearsActive:4,color:"var(--accent-green)",products:89,shipTime:"10-20 days",shipCost:"$3-8",minOrder:"$25",quality:87,communication:89,value:84,topProducts:["Wall Art","LED Frame","Plant Pot","Candle Holder","Photo Frame"]}
];
...
const SupplierIntelligencePlugin = {
  ...
  mount(_ctx) {
    ...
    const avgScore = Math.round(analyzed.reduce(function(a,x){return a+x.score;},0)/analyzed.length);
    const verifiedCount = analyzed.filter(function(x){return x.supplier.verified;}).length;
    const highRisk = analyzed.filter(function(x){return x.risk.level==='HIGH';});
    const avgResponse = (analyzed.reduce(function(a,x){return a+x.supplier.responseRate;},0)/analyzed.length).toFixed(1);
  ...
  showDetail(supplier) {
        ...
        <div class="sci-detail-grid">
          ...
          <div class="sci-detail-card">
            ...
            <div class="sci-detail-products">
              ${(supplier.topProducts||[]).map(function(p){return '<span class="sci-detail-product-chip" tabindex="0" role="button" aria-label="Search for '+p+'" data-product="'+p+'">'+p+'</span>';}).join('')}
            </div>
          </div>
        </div>
    ...
    const closeDetail = function(){ panel.classList.remove('sci-detail-open'); panel.innerHTML=''; };
    ...
    panel.querySelectorAll('.sci-detail-product-chip').forEach(function(chip){
      ...
      chip.addEventListener('keydown', function(e){ if(e.key==='Enter'||e.key===' '){ e.preventDefault(); handler(); }});
    });
  },
  ...
  renderRiskAlerts(analyzed) {
    ...
    if(!riskList) return;
    const risks = analyzed.filter(function(x){return x.risk.level!=='LOW';});
    if(risks.length===0){
    ...
    riskList.innerHTML = risks.map(function(x){
      ...
      return '<div class="sci-risk-card" tabindex="0" role="button" aria-label="View '+esc(s.name)+' details" data-name="'+esc(s.name)+'" style="border-left:3px solid '+esc(x.risk.color)+'">'+
        '<div class="sci-risk-header">'+
          '<div class="sci-risk-avatar" style="background:'+esc(x.risk.color)+'22;color:'+esc(x.risk.color)+'">'+esc(s.name.charAt(0))+'</div>'+
          '<div><div class="sci-risk-name">'+esc(s.name)+'</div><div class="sci-risk-platform">'+esc(s.platform)+' · '+esc(s.location)+'</div></div>'+
          '<div class="sci-risk-badge" style="background:'+esc(x.risk.color)+'18;color:'+esc(x.risk.color)+';border:1px solid '+esc(x.risk.color)+'44">'+esc(x.risk.level)+' RISK</div>'+
        '</div>'+
        '<div class="sci-risk-reasons">'+reasons.map(function(r){return '<span class="sci-risk-reason">⚠ '+esc(r)+'</span>';}).join('')+'</div>'+
    ...
    riskList.querySelectorAll('.sci-risk-card').forEach(function(card){
      const handler = function(){
        const s = analyzed.find(function(x){return x.supplier.name===card.dataset.name;});
  ...
  renderScoreboard(analyzed) {
    ...
    scoreBody.innerHTML = analyzed.map(function(x,i){
      const s=x.supplier;
      return '<tr tabindex="0" role="button" aria-label="View '+esc(s.name)+' details" data-name="'+esc(s.name)+'">'+
        '<td class="sci-rank">#'+(i+1)+'</td>'+
        '<td><div class="sci-tbl-name"><div class="sci-tbl-avatar" style="background:'+esc(s.color)+'22;color:'+esc(s.color)+'">'+esc(s.name.charAt(0))+'</div>'+esc(s.name)+'</div></td>'+
        '<td>'+esc(s.platform)+'</td>'+
        '<td><span class="sci-grade" style="background:'+esc(x.grade.color)+'18;color:'+esc(x.grade.color)+'">'+esc(x.grade.grade)+'</span></td>'+
        '<td><span class="sci-tbl-score" style="color:'+esc(x.grade.color)+'">'+x.score+'</span></td>'+
        '<td><span class="sci-risk-pill" style="background:'+esc(x.risk.color)+'18;color:'+esc(x.risk.color)+'">'+esc(x.risk.level)+'</span></td>'+
    ...
    scoreBody.querySelectorAll('tr').forEach(function(row){
      const handler = function(){
        const s = analyzed.find(function(x){return x.supplier.name===row.dataset.name;});
        if(s) self.showDetail(s.supplier);
      };
  ...
  renderBreakdown(analyzed) {
    ...
    breakdownGrid.innerHTML = analyzed.map(function(x){
      const s=x.supplier;
      return '<div class="sci-bd-card" tabindex="0" role="button" aria-label="View '+s.name+' breakdown" data-name="'+s.name+'">'+
  ...
  renderBackups(){
    ...
    backupGrid.innerHTML = backups.map(function(b){return '<div class="sci-backup-card" tabindex="0" role="button" aria-label="Compare '+esc(b.primary)+' with '+esc(b.backup)+'" data-primary="'+esc(b.primary)+'" data-backup="'+esc(b.backup)+'">'+
      '<div class="sci-backup-category">'+esc(b.category)+'</div>'+
    ...
    backupGrid.querySelectorAll('.sci-backup-card').forEach(function(card){
      const handler = function(){
        ...
        const analyzed = self._analyzed || [];
        const found = analyzed.find(function(x){return x.supplier.name===primaryName;});
  ...
  renderTips(){
    ...
    tipsGrid.innerHTML = tips.map(function(t){return '<div class="sci-tip-card" tabindex="0" role="button" aria-label="'+t.title+'" data-tip="'+t.title+'">'+
