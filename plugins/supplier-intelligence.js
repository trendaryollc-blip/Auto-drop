  ...
  const SUPPLIER_DATABASE = [
    {
      ...
      shipCost: 'Free',
      minOrder: '1',
      paymentTerms: 'PayPal, T/T',
      color: '#06b6d4',
      sampleAvailable: true,
      customPackaging: true,
      dropshipSupport: true,
      yearsActive: 6,
      topProducts: ['Wireless Earbuds Pro', 'Smart Watch X200', 'USB-C Hub 7-in-1', 'Bluetooth Speaker Boom'],
    ...
    },
    {
      ...
      dropshipSupport: true,
      yearsActive: 4,
      topProducts: ['Smart Thermostat Elite', 'Motion Sensor Light', 'Smart Plug Hub', 'WiFi Camera 4K'],
    ...
    },
    {
      ...
      shipCost: 'Free',
      minOrder: '1',
      paymentTerms: 'PayPal, Credit Card',
      color: '#10b981',
      sampleAvailable: true,
      customPackaging: false,
      dropshipSupport: true,
      yearsActive: 8,
      topProducts: ['Automatic Pet Feeder', 'Cat Tree Tower Deluxe', 'Pet Grooming Kit', 'Dog Harness Adjustable'],
    ...
    },
    {
      ...
      shipCost: '$5.99',
      minOrder: '5',
      paymentTerms: 'Net 15, Credit Card',
      color: '#f97316',
      sampleAvailable: false,
      customPackaging: true,
      dropshipSupport: true,
      yearsActive: 3,
      topProducts: ['Resistance Bands Set', 'Adjustable Dumbbells', 'Yoga Mat Premium', 'Foam Roller Pro'],
    ...
    },
    {
      ...
      dropshipSupport: false,
      yearsActive: 12,
      topProducts: ['Cotton T-Shirt Bulk', 'Hoodie Fleece Lined', 'Denim Jacket Classic', 'Active Leggings'],
